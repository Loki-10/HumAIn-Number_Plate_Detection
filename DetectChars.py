...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt("cs.txt", np.float32)
    except:
        print("error, unable to open cs.txt, exiting program\n")
        os.system("pause")
        return False


    try:
        npaFlattenedImages = np.loadtxt("pics.txt", np.float32)
    except:
        print("error, unable to open pics.txt, exiting program\n")
        os.system("pause")
        return False
...
def recognizeCharsInPlate(imgThresh, listOfMatchingChars):
    ...
    for currentChar in listOfMatchingChars:
        ...
        cv2.rectangle(imgThreshColor, pt1, pt2, Main.Green_colour, 2)
